...
#define Lcd_Light_ON   GPIOA->BSRR = 1 << 1
#define Lcd_Light_OFF  GPIOA->BRR  = 1 << 1


#define Set_Cs  GPIOD->BSRR = 1 << 7
#define Clr_Cs  GPIOD->BRR = 1 << 7

#define Set_Rs  GPIOD->BSRR = 1 << 11
#define Clr_Rs  GPIOD->BRR = 1 << 11

#define Set_nWr GPIOD->BSRR = 1 << 5
#define Clr_nWr GPIOD->BRR = 1 << 5

#define Set_nRd GPIOD->BSRR = 1 << 4
#define Clr_nRd GPIOD->BRR = 1 << 4
